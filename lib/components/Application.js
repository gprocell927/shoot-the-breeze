...
import { _, pick, map, extend, uniq, filter} from 'lodash';
...
export default class Application extends Component {
  ...
  handleInputChange(e){ //explain this to Gabi
  ...
  styleCharCounterRed(){
    document.querySelector('#character-counter-output').style.color = "red";
  }

  styleCharCounterWhite(){
    document.querySelector('#character-counter-output').style.color = "white";
  }
