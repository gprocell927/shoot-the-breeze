...
//TODO: for refactor tractor: break out components as noted above; try to refactor JS if statements; get closer match to specs if time permits
...
export default class Application extends Component {
  ...
  render(){ //TODO: make dumb component out of input; footer in own component; button components broken down
    let filteredMessages = this.props.messages;

    //children can be used to pass in components or text
    return (
      <div onLoad={this.initFirebase()}>
        <header>
          <h2
            id="page-main-title"
            children="Shoot the Breeze"
          />
          <FilterInputField
